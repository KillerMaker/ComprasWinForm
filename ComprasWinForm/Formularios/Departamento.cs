...
namespace ComprasWinForm.Formularios
{
    public partial class Departamento : Form
    {
        ...
        private async void btnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                departamento = new CDepartamento(int.Parse(txtId.Text), txtNombre.Text,cmbEstado.SelectedIndex+1);
        ...
        private async void btnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                departamento = new CDepartamento(null, txtNombre.Text, cmbEstado.SelectedIndex+1);
        ...
        {
            Excel reporte = new Excel("Departamento");
